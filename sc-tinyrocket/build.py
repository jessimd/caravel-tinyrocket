...
def build_top():
    ...
    chip.set('input', 'verilog', 'user_project_wrapper.v')
    ...
    chip.clock('wb_clk_i', period=25)

    # Set top-level source files.
    #chip.add('input', 'verilog', f'{CARAVEL_ROOT}/verilog/rtl/defines.v')
    # chip.add('input', 'verilog', 'ChipTop.bb.v')
    chip.add('input', 'verilog', 'user_project_wrapper.v')
    chip.add('input', 'verilog', 'ChipTop.v')
    chip.add('input', 'verilog', 'srams/sram_64x21/sky130_sram_0kbytes_1rw_21x64_21.bb.v')
    chip.add('input', 'verilog', 'srams/sram_1024x32/sky130_sram_4kbytes_1rw_32x1024_32.bb.v')
    chip.add('input', 'verilog', 'srams/sram_1024x37/sky130_sram_5kbytes_1rw_37x1024_37.bb.v')
    chip.add('input', 'verilog', 'srams/sram_4096x8/sky130_sram_4kbyte_1rw_32x1024_8.bb.v')

    # Set top-level die/core area.
    #chip.set('asic', 'diearea', 'lock', True)
    ...
    chip.set('asic', 'macrolib', ['sky130sram_64x21', 'sky130sram_1024x32', 'sky130sram_1024x37', 'sky130sram_4096x8'])
        
    for step in ('extspice', 'drc'):
        chip.set('tool', 'magic', 'var', step, '0', 'exclude', ['sky130sram_64x21', 'sky130sram_1024x32', 'sky130sram_1024x37', 'sky130sram_4096x8'])
    chip.set('tool', 'netgen', 'var', 'lvs', '0', 'exclude', ['sky130sram_64x21', 'sky130sram_1024x32', 'sky130sram_1024x37', 'sky130sram_4096x8'])
...
define_pdn_grid -macro -name macro -voltage_domain Core -halo 3.0 -starts_with POWER -grid_over_boundary -cells {sky130_sram_4kbyte_1rw_32x1024_8, sky130_sram_0kbytes_1rw_21x64_21, sky130_sram_4kbytes_1rw_32x1024_32, sky130_sram_5kbytes_1rw_37x1024_3}
...
pdngen''')
    ...
    with open('macroplace_top.tcl', 'w') as mf:
        mf.write('''
# Place SRAMs
place_cell -inst_name mprj.system.tile_prci_domain.tile_reset_domain.tile.dcache.data.data_arrays_0.data_arrays_0_ext.mem_0_0.sram_4096x8 -origin {99.82 97.92} -orient R0 -status FIRM
place_cell -inst_name mprj.system.tile_prci_domain.tile_reset_domain.tile.dcache.data.data_arrays_0.data_arrays_0_ext.mem_0_1.sram_4096x8 -origin {99.82 549.44} -orient R0 -status FIRM
place_cell -inst_name mprj.system.tile_prci_domain.tile_reset_domain.tile.dcache.data.data_arrays_0.data_arrays_0_ext.mem_0_2.sram_4096x8 -origin {99.82 998.24} -orient R0 -status FIRM
place_cell -inst_name mprj.system.tile_prci_domain.tile_reset_domain.tile.dcache.data.data_arrays_0.data_arrays_0_ext.mem_0_3.sram_4096x8 -origin {99.82 1449.76} -orient R0 -status FIRM
place_cell -inst_name mprj.system.tile_prci_domain.tile_reset_domain.tile.frontend.icache.data_arrays_0.data_arrays_0_0_ext.mem_0_0.sram_1024x32 -origin {99.82 2197.76} -orient R0 -status FIRM
place_cell -inst_name mprj.system.tile_prci_domain.tile_reset_domain.tile.frontend.icache.tag_array.tag_array_ext.mem_0_0.sram_64x21 -origin {1199.68 97.92} -orient R0 -status FIRM
''')
